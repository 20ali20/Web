...
//as well as Captcha for extra layer of security against BruteForce attack
    ...
    if(isset($_POST['btn-login']))
    {
        ...
        //incremet numLogin and update Last Login date  
        $numLogin = (int) $row['numLogin'];
        $numLogin++;
        ...
        if($count == 1 && $hashPass == $row['password'] )
        {
            if(isset($_POST["captcha"])&&$_POST["captcha"]!=""&&$_SESSION["code"]==$_POST["captcha"])
            {
                ...
                mysqli_query($connection,"UPDATE users SET lastlogin='$lastLogin', numLogin='$numLogin' WHERE username='$uname'");
