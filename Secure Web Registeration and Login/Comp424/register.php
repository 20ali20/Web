...
if(isset($_POST['btn-signup']))
{
   ...
   // $_SESSION['password'] = $_POST['pass'];
    ...
    $upassC= mysqli_real_escape_string($connection,strip_tags($_POST['passC']));
	...
	if ($uemail==$uemailC){
        ...
        if($count==0 && $emailCheck==0){
            if (ctype_alnum($uname))
            {
                ...
                ?>
                <script>alert('Your username or email address is already taken, please try another one!');</script>
                <?php
        }
            ...
            <div id="login-form">
                <form method="post">
                    <table align="center" width="50%" border="0">
                        ...
                        <tr>
                            <td>
                                <input type="password" size="15" name="passC"  placeholder="Confirm your Password" required />
                            </td>
                        </tr>
                        <tr>
                            <td>
